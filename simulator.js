Simulator = {
    _unitsStats: {
        "axe":
        {
            ...
            "iron":40,
            "food":1,
            "build_time":1320,"attack":45,
            "def_inf":10,"def_kav":5,
            "def_arc":10,"speed":14,
            "load":10,"type":1,
            "points_att":4,
            "points_def":1
        ...
        "archer":
        {
            ...
            "iron":60,
            "food":1,
            "build_time":1500,"attack":25,
            "def_inf":10,"def_kav":30,"def_arc":60,"speed":14,
            "load":10,"type":3,
            "points_att":2,
            "points_def":5
        },
        "light_cavalry":
        {
            ...
            "iron":250,
            "food":4,
            "build_time":1800,"attack":130,"def_inf":30,"def_kav":40,"def_arc":30,"speed":8,
            "load":80,"type":2,
            "points_att":13,
            "points_def":5
        },
        "mounted_archer":
        {
            ...
            "iron":150,
            "food":5,
            "build_time":2200,"attack":150,"def_inf":40,"def_kav":30,"def_arc":50,"speed":8,
            "load":50,"type":3,
            "points_att":12,
            "points_def":6
        },
        "heavy_cavalry":
        {
            ...
            "iron":600,
            "food":6,
            "build_time":3200,"attack":150,"def_inf":200,"def_kav":80,"def_arc":180,"speed":9,
            "load":50,"type":2,
            "points_att":15,
            "points_def":23
        },
        "ram":
        {
            ...
            "iron":200,
            "food":5,
            "build_time":4800,"attack":2,
            "def_inf":20,"def_kav":50,"def_arc":20,"speed":24,
            "load":0,"type":1,
            "points_att":8,
            "points_def":4
        },
        "catapult":
        {
            ...
            "iron":100,
            "food":8,
            "build_time":7200,"attack":100,"def_inf":100,"def_kav":50,"def_arc":100,"speed":24,
            "load":0,"type":1,
            "points_att":10,"points_def":12
        },
        "knight":
        {
            "name":"knight",
            ...
            "iron":0,
            "food":1,
            "build_time":21600,"attack":150,"def_inf":250,"def_kav":400,"def_arc":150,"speed":8,
            "load":100,"type":2,
            "points_att":20,"points_def":40
        },
        "snob":
        {
            "name":"snob",
            ...
            "clay":50000,
            "iron":50000,
            "food":100,"build_time":10800,"attack":30,"def_inf":100,"def_kav":50,"def_arc":100,"points_att":200,"points_def":200,"speed":35,
            "load":0,"type":1,
            "special":1
        },
        "trebuchet":
        {
            ...
            "clay":2000,
            "iron":2000,
            "food":10,"build_time":1800,"attack":30,"def_inf":200,"def_kav":250,"def_arc":200,"points_att":0,"points_def":25,
            "speed":50,"load":0,"type":1,
            "special":1
        },
        "doppelsoldner":
        {
            ...
            "iron":2400,
            "food":6,
            "build_time":1800,"attack":300,"def_inf":100,"def_kav":100,"def_arc":50,"points_att":25,
            "points_def":10,"speed":14,
            "load":10,"type":1,
            "special":1}},
            _unitToAttackType: {
                spear: "attack",
            ...
            _getAttackSum: function (units) {
                ...
                for(var unit in units) {
                    sum[this._unitToAttackType[unit]] += this._unitsStats[unit].attack * units[unit];
                }
                return sum;
            },
            ...
            _calcWallAfterFight: function (attacker, defender, wall, glaubensbonus, morgenstern) {
                ...
                if (rammen === 0 || wall === 0) return wall;
            ...
            simulate: function (attackerUnits, defenderUnits, wall, nightbonus, moral, luck, unglaeubigAngreifer, unglaeubigVerteidiger, palaItems) {
                ...
                wall = wall || 0;
                moral = moral || 100; moral /= 100;
                luck = luck || 0; luck = 1 + luck/100;
                ...
                do{
                    var attackStrength = this._getAttackSum(attackerUnits);
                    ...
                    console.log(attackFood, attackFoodSum);
...
function getSimulatorInput(){
    var result = {asString: {attackUnits: {}, defendUnits: {}}, asInteger: {attackUnits: {}, defendUnits: {}}};
...
/*
   ...
   inputs[0].value = units.attackUnits[unit] || '';
   inputs[1].value = units.defendUnits[unit] || '';
   i++;
   }
